...
$\left([s_i,f_i]  \cap [s_j,f_j]  = \emptyset     \right)$, l'\textbf{obiettivo} è quello di trovare un sottoinsieme $A' \subseteq A$ tale che:
\begin{itemize}
...
con $m\ge k$. L\textbf{obiettivo} è dimostrare che $\bm{k = m}$, cioè che l'algoritmo greedy seleziona tante attivtà quante ne ha 
una soluzione ottima. Procediamo per \textbf{induzione}:\\
CONTNUAREEE
