...
$c \in C$ sia presente con una certa frequenza $f_i$ (\texttt{c.freq}). L'\textbf{obiettivo}
è:
\begin{enumerate}
...
Dato $A = \{ a_1, a_2,\dots, a_n \}$ insieme di attività, dove ciascuna $a_i$
ha un tempo di inizio $s_i\in \mathbb{R}$ e un tempo di fine $f_i\in\mathbb{R}$
con $s_i< f_i$, e dato il vincolo di compatibilità ($a_i$ e $a_j$)
