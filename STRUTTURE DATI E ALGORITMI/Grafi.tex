...
\begin{enumerate}
    ...
    Nella colonna successiva, quindi, ci saranno le distanze aggiornate e ora continuiamo il processo ripartendo il con lo step (1.) (selezionando la distanza minima ecc...), mentre il nodo che avevamo in precedenza selezionato
...
L'algortmo di \textbf{Bellman-Ford} risolve il problema dei cammini minimi da sorgente unica nel caso generale in cui i  pesi degli archi \textbf{possono essere negativi}.
