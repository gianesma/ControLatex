...
\begin{itemize}
    ...
    \item \textbf{Processore} $\xrightarrow{}$ prende il testo C senza direttive, verifica la correttezza sintattica e lo traduce in assembly. Con il comando: [gcc -S hello.i].
    \item \textbf{Processore} $\xrightarrow{}$ prende un programma in assembly e lo traduce in codice macchina generando un file oggetto binario. Tramite: [gcc -c hello.s]
    \item \textbf{Processore} $\xrightarrow{}$ prende i vari file oggetto e li collega insieme a formare un unico file eseguibile. Nel nostro caso collega insieme “hello.o” contenente il codice macchina e “printf.o” contenente il codice macchina che realizza la funzione “printf” invocata dal programma, dando come risultato il file eseguibile “hello”. Con l'utilizzo del comando: [gcc hello.o -o hello].
\end{itemize}
